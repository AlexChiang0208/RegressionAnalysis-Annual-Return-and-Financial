...
stock = pd.read_csv(path + '/Origin_Data/' + 'stock_price.csv', encoding = 'cp950', 
                    parse_dates=True, index_col='年月日')

industry = pd.read_csv(path + '/Origin_Data/' + 'industry.csv', 
                       encoding = 'cp950', index_col='年月')

financial_index = pd.read_csv(path + '/Origin_Data/' + 'untidy_features.csv', 
                              encoding = 'cp950', index_col='年月')
...
# Save
reg_XY.to_csv(path + 'Tidy_Data/reg_XY.csv')
stock_price.to_csv(path + 'Tidy_Data/Y_test_StockPrice.csv')
X_test.to_csv(path + 'Tidy_Data/X_test.csv')

# Read
a = pd.read_csv(path + 'Tidy_Data/reg_XY.csv')
b = pd.read_csv(path + 'Tidy_Data/Y_test_StockPrice.csv')
c = pd.read_csv(path + 'Tidy_Data/X_test.csv')
#%%
...
stock = pd.read_csv(path + '/Origin_Data/' + 'stock_price_new.csv', encoding = 'cp950', 
                    parse_dates=True, index_col='年月日')
...
# Save
reg_XY.to_csv(path + 'Tidy_Data/reg_XY_new.csv')

# Read
d = pd.read_csv(path + 'Tidy_Data/reg_XY_new.csv')
